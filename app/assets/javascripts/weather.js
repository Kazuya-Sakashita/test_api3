class OpenWeatherMapClient {
  constructor() {
    ...
    this._apiKey = '4e7e5f143a69d341b7903a801ff2a202'
  }

  async weatherAt(cityName) {
    let reqestUrl = `${this._baseUrl}/weather?q=${cityName}&units=metric&appid=${this._apiKey}`
    let request =
...
class WeatherIndexPage {
  ...
  static buildHTML(json) {
    return (
      ...
      <div class="weather-temp">${Math.round( json['main']['temp'] )} &#8451</div>
      `
    )
  }
}
